...
import { recentFilesMock } from "../mocks/RecentFilesMock";
import { projectsMock } from "../mocks/ProjectsMock";
import { communityPostsMock } from "../mocks/CommunityPostsMock";
import { Input } from "@/components/ui/input";
import { tutorialsMock } from "../mocks/TutorialsMock";
          ...
          <TabsContent value="home" className="space-y-8 mt-0">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              <section className="space-y-4">
                ...
                <div className="rounded-3xl border">
                  <div className="grid grid-cols-1 divide-y">
                    {recentFilesMock.slice(0, 4).map((file) => (
                      <motion.div
                        key={file.name}
                        whileHover={{
              ...
              <section className="space-y-4">
                ...
                <div className="rounded-3xl border">
                  <div className="grid grid-cols-1 divide-y">
                    {projectsMock.slice(0, 3).map((project) => (
                      <motion.div
                        key={project.name}
                        whileHover={{
                          backgroundColor: "rgba(0,0,0,0.02)",
            ...
            <section>
              ...
              >
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div className="space-y-2">
                    <h2 className="text-3xl font-bold">
                      Creative Apps Collection
                    </h2>
                    <p className="max-w-[600px] text-white/80">
                      Discover our full suite of professional design and
              ...
              >
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div className="space-y-2">
                    ...
                    <p className="max-w-[600px] text-white/80">
                      Access, manage, and share all your design files in one
                      place.
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-3">
              ...
              >
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div className="space-y-2">
                    ...
                    <p className="max-w-[600px] text-white/80">
                      Organize your creative work into projects and collaborate
                      with your team.
                    </p>
                  </div>
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <Card className="overflow-hidden rounded-3xl">
                  <div className="aspect-video bg-gradient-to-br from-amber-500 to-red-600 p-6 text-white">
                    ...
                    <p className="text-sm text-white/80">
                      Multi-channel marketing assets
                    </p>
                  </div>
                  <CardFooter className="flex justify-between p-4">
                    <Badge variant="outline" className="rounded-xl">
          ...
          <TabsContent value="learn" className="space-y-8 mt-0">
              ...
              >
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div className="space-y-2">
                    ...
                    <p className="max-w-[600px] text-white/80">
                      Expand your creative skills with tutorials, courses, and
                      resources.
                    </p>
                  </div>
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                {tutorialsMock.slice(0, 3).map((tutorial) => (
                  <motion.div
                    key={tutorial.title}
                    whileHover={{ scale: 1.02, y: -5 }}
                    whileTap={{ scale: 0.98 }}
            ...
            <section className="space-y-4">
              ...
              <div className="rounded-3xl border overflow-hidden">
                <div className="divide-y">
                  {tutorialsMock.slice(3, 5).map((tutorial) => (
                    <motion.div
                      key={tutorial.title}
                      whileHover={{ scale: 1.02, y: -5 }}
                      whileTap={{ scale: 0.98 }}
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
                <Card className="overflow-hidden rounded-3xl border-2 hover:border-primary/50 transition-all duration-300">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>
                      Master the basics of user interface and experience design
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-2">
